...
df <- read_csv("Final working datasets/Monthly_features_one_indicator.csv")
...
write_csv(lockdown_summary_df, "lockdown_summary_aftereffects.csv")
write_csv(df, "total_features_to_work_with.csv")
