...
```
```{r}
df <- read_excel("C:/Users/yuval/OneDrive/מסמכים/BGU/4th_semester/data_analysis/research/project datasets/covid_monthly_domesticviolence.xlsx")
...
```
```{r}
write.csv(df_filtered, "filtered_domesticviolence_monthly.csv", row.names = FALSE)
