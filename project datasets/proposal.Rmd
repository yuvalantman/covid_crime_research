...
This analysis examines how home confinement during crises, combined with stressors like mortality and unemployment, affects violence patterns. Answering this is challenging due to underreporting and fragmented, inconsistent data across countries and timeframes.
...
This approach is unique in combining diverse international datasets and applying data science to a sensitive, underexplored issue.

We aim to explore how reported domestic violence changed during the pandemic and whether it is linked to key pandemic related stressors. We will use regression models with non linear and interaction terms, testing variables such as cumulative lockdown duration and lagged unemployment to assess their predictive power.
